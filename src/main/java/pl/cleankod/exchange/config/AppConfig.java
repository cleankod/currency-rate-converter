...
import pl.cleankod.util.domain.NbpApiErrorDecoder;
...
public class AppConfig {
    ...
    @Bean
    AccountService accountService(FindAccountAndConvertCurrencyUseCase findAccountAndConvertCurrencyUseCase, FindAccountUseCase findAccountUseCase) {
