...
import pl.cleankod.exchange.core.service.mapper.MoneyMapper;
...
public class ApplicationConfiguration {
    ...
    AccountService accountService(AccountMapper accountMapper,
        ...
        return new AccountServiceImpl(accountMapper, currencyConversionService, accountRepository, baseCurrency);
    }
}
